...
const DICTIONARY: Record<Locale, Record<TranslationKey, string>> = {
  ...
  vi: {
    ...
    color: 'Màu',
    completeYourOrder: 'Gửi yêu cầu đặt hàng',
    contact: 'Liên hệ',
    ...
    delivery: 'Giao hàng',
    detailsSavedNextTime: 'Chúng tôi chỉ dùng thông tin này để xác nhận đơn với bạn.',
    details: 'Chi tiết',
    ...
    payment: 'Thanh toán',
    phone: 'Số điện thoại',
    placeOrder: 'Gửi yêu cầu',
    placingOrder: 'Đang gửi yêu cầu',
    postalCodeOptional: 'Mã bưu chính',
    remove: 'Xóa',
    returningCustomer: 'Đã từng để lại thông tin',
